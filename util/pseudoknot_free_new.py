...
def entrna_train(real_RNA_loc = "./util/RNASTRAND_pseudoknot_free_feature.csv", folder_simulation_result = "./util/RNASTRAND_extract_feature_pseudoknot_free_new/"):
    scaler, clf, train_acc = bulid_model(real_RNA_loc,folder_simulation_result)
    return train_acc


def entrna_train_our_ver(real_RNA_loc = "./util/RNASTRAND_pseudoknot_free_feature.csv", folder_simulation_result = "./util/RNASTRAND_extract_feature_pseudoknot_free_new/"):
    scaler, clf, train_acc = bulid_model(real_RNA_loc,folder_simulation_result)
    return scaler, clf
