...
def entrna_main_ori(seq,sec_str,scaler, clf,real_RNA_loc = "./util/RNASTRAND_pseudoknot_free_feature.csv", folder_simulation_result = "./util/RNASTRAND_extract_feature_pseudoknot_free/"):
    df_pred = extract_features_ori.extract_features_pseudoknot_free(seq,sec_str)
    #scaler, clf, train_acc = bulid_model(real_RNA_loc,folder_simulation_result)
    foldability = pred_foldability(df_pred,clf, scaler)
    return foldability


def entrna_main_return_all_features_ori(seq,sec_str,scaler, clf,real_RNA_loc = "./util/RNASTRAND_pseudoknot_free_feature.csv", folder_simulation_result = "./util/RNASTRAND_extract_feature_pseudoknot_free/"):
    df_pred = extract_features_ori.extract_features_pseudoknot_free(seq,sec_str)
    #scaler, clf, train_acc = bulid_model(real_RNA_loc,folder_simulation_result)
    #foldability = pred_foldability(df_pred,clf, scaler)
...
def entrna_train_ori(real_RNA_loc = "./util/RNASTRAND_pseudoknot_free_feature.csv", folder_simulation_result = "./util/RNASTRAND_extract_feature_pseudoknot_free/"):
    scaler, clf, train_acc = bulid_model(real_RNA_loc,folder_simulation_result)
    return train_acc

"""
def entrna_train_our_ver_ori(real_RNA_loc = "./util/RNASTRAND_pseudoknot_free_feature.csv", folder_simulation_result = "./util/RNASTRAND_extract_feature_pseudoknot_free/"):
    scaler, clf, train_acc = bulid_model(real_RNA_loc,folder_simulation_result)
    return scaler, clf
"""

def entrna_train_our_ver_ori(real_RNA_loc = "/home/menghan/Dropbox (ASU)/RNA/ENTRNA-master_new_MH/ENTRNA-master/util/RNASTRAND_pseudoknot_free_feature.csv", folder_simulation_result = "/home/menghan/Dropbox (ASU)/RNA/ENTRNA-master_new_MH/ENTRNA-master/util/RNASTRAND_extract_feature_pseudoknot_free/"):
    scaler, clf, train_acc = bulid_model(real_RNA_loc,folder_simulation_result)
    return scaler, clf
