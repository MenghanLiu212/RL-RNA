...
import random
import SeqAttRollOut_RNAfold_only_MFE_4_branch_4_min_Agave_5s as SeqAttRollOut_RNAfold
import RNA
#import ENTRNA
...
def Main_function(OriginalRNAChain,scaler, clf, scaler_ori, clf_ori):
    ...
    BestWholeChainEverInMemory_2 = SeqAttRollOut_RNAfold.BestWholeChainEverInMemory([], 0, 'initial')
    BestWholeChainEverInMemory_3 = SeqAttRollOut_RNAfold.BestWholeChainEverInMemory([], 0, 'initial')
    BestWholeChainEverInMemory_4 = SeqAttRollOut_RNAfold.BestWholeChainEverInMemory([], 0, 'initial')
    Max_branch_num = 4
